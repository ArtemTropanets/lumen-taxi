<template>
    <div class="mt-5">
        ...
        <div
            class="rounded-2 routes"
            :class="{'highlighted-routes': highlightRoutes}"
        >
            <div
                :id="`capture_${type}`"
            >
                        ...
                        >
                            <div class="row">
                                ...
                                <div class="col-4 align-self-center text-end">
                                    <button
                                        v-show="route.persons.length && !printScreenMode"
                                        class="btn btn-sm btn-primary"
                                        style="width: 70px;"
...
.highlighted-routes {
    box-shadow: 0 0 3px 3px indianred;
}
</style>
